...
\begin{document}
    ...
    } hybrid grammars for constituent parsing, and refer to them as hybrid grammars (or even shorter as \abrv{hg}).
...
%
    ...
    \null\hfill
    \begin{tikzpicture}[baseline=(bottom.base),level distance=6ex, font=\small, inner sep=2pt, level 2/.style={sibling distance=6em}, level 1/.style={sibling distance=8em}]
