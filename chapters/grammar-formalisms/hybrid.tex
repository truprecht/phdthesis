...
\begin{document}
    ...
    Intuitively, the \abrv{lcfrs} compositions are in charge of processing string during parsing and defining the sets of derivations for given sentences.
    ...
    As in the previous section, we refrain from repeating the definitions with small adjustments and focus on the particularities of \abrv{hg} as a formalism.
