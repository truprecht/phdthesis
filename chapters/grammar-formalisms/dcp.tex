...
\begin{document}
    ...
    This corresponds to the information flow from the bottom to the top in a derivation expressed by synthetic attributes (first-order substitution) and the flow from the top to the bottom in a derivation by inherent attributes (second-order substitution) in attribute grammars. \citep[cf.\@ Section 1: Notations]{Der88}
    ...
    \begin{definition}[Composition]
        ...
        The identifier \(\C^{\varGamma\varSigma}\) debotes the set of all \abrv{dcp} compositions \(\bigcup_{k \in \DN} \C^{\varGamma\varSigma}_{k}\).
