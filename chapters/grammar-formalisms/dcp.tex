...
\begin{document}
    ...
    This corresponds to the information flow from the bottom to the top in a derivation as expressed by synthetic attributes (first-order substitution) and the information flow from the top to the bottom in a derivation by inherent attributes (second-order substitution) in attribute grammars. \citep[cf.\@ Section 1: Notations]{Der88}
    ...
    Some restrictive forms that excluded circular dependencies in the expressed productions were introduced to solve this issue. \citep[Section~3.4 about non-circular attribute grammars]{Cou82}
