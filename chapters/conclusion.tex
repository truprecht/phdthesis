...
\begin{document}
    ...
    In recent years, some parts of the \abrv{nlp} community have written off parsing with grammar formalisms as being too inaccurate and slow (cf.\@ \citealp[Section~1]{StaSte20}; and \citealp[Section~10]{zhang2020survey}).
