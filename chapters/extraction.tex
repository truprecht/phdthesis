...
\begin{document}
    ...
    \begin{compactenum}
        \item
            The process described in \cref{sec:extraction:readoff} first extracts a derivation \abrv{lcfrs} rules for each tree in a treebank.
    ...
    \end{compactenum}
    These processes use the rank transformations described in \cref{section:ranktransformations}.
