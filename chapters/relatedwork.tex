...
\begin{document}
    ...
    \section{Concurrent Work in Constituent Parsing}\label{sec:literature:constituency}
    ...
    We gather relevant publications in the field of constituent parsing, and categorize these publications into general concepts that we consider as traditional or established for parsing.
