...
\begin{document}
    ...
    \emph{Linear context-free rewriting systems} (short: \abrv{lcfrs}) are described in detail in \cref{sec:grammar:lcfrs}.
    ...
    A recent investigation by \citet{bai2023constituency} exploited pretrained large language models (short: \abrv{llm}s), such as \abrv{gpt4} \citep{openai2023gpt4}.
