...
\begin{document}
    ...
    \paragraph{Fanout-Restricted Parsing with \abrv{Dcp} Supertags}
    \abrv{Dcp} supertags are tuples containing a lexical \abrv{dcp} rule (with an integer terminal) and a positive integer that restricts sets of leaves in derivations rooted by the supertag.
