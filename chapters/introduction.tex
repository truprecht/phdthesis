...
\begin{document}
    ...
    These two expressions for the syntax are not mutually exclusive, and we will later consider lexical head as an extension; but for now, we focus on constituent trees.
