...
%    \end{proof}
    ...
    \begin{example}[Statistical parsing in the empirical prediction framework.]
        ...
        Probabilistic grammars can generate constituent trees (trivially in tandem with a sequence of tokens) by probabilistically sampling rules.
    \end{example}
    ...
    \begin{itemize}
        ...
        \item
            ...
            Both are quantified in terms of real values:
                A term for the magnitude of all parameters is added to the loss and scaled by weight decay. This discourages high values for parameters associated with being specifically tied to training instances (called overfitting).
