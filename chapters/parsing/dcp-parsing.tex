...
\begin{document}
    ...
    \paragraph{Parse items, backtraces and parse states.} During the procedures, we construct tuples of the form \((a, b, w)\) (in lines 7--9, 18--19 and 26--29); each of this tuple represents an investigation in a derivation rooted in a \abrv{dcp} supertag \(s \in S\) as follows:
    \begin{itemize}
