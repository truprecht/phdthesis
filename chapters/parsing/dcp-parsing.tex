...
\begin{document}
    ...
    The algorithm is derived from \citet[Algorithm 2, 3 and 4]{HuaChia05} with some adjustments to accommodate our grammar format (i.e.\@ multiple initial nonterminals, non-binary grammars, and the form of \abrv{dcp} supertags).
