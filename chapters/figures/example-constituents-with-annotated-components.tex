...
\begin{document}
 ...
 %      node distance=3ex,
      ...
      \end{scope}
        ...
        \begin{scope}[gray,every node/.style={align=center, text width=3.5cm}]
          \draw (sbar.north-|highlights)
                    ...
                    node[right] (cnlabel) {constituent symbols}
    ...
    \matrix[right=4cm of pos.south east, anchor=south west] (rpos) [matrix of nodes, outer sep=0pt, inner sep=0pt, row sep=2ex, column sep=7pt] {
    ...
    \begin{scope}[every node/.style={inner sep=2pt, font=\small}, level distance=4ex]
        \node[above=21.5ex of rpos-1-4, xshift=2ex] (sbar) {\cn{sbar}}
        child { node {\cn{s}}
            ...
            child { node {\cn{vp}}
                ...
                child { node {\cn{vp}}
                    ...
                    child { node (wh) {\cn{wh}}
                        child {node  {1} }}
                    child { node[yshift=-4ex] {5} }
                    child { node {\cn{prt}}
                        child { node {6} }}}
                child { node[yshift=-8ex] {4} }}
