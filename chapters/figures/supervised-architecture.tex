...
\begin{document}
    ...
    \begin{tikzpicture}[>=stealth]
        ...
        \foreach \i in {1,2,...,6}{
            \vectortwo{above=3ex of input-1-\i}{ceb-\i}
            \vectortwo{above=0px of ceb-\i}{cef-\i}
            \vectorthree{above=0px of cef-\i}{we-\i}

            \vectortwo{above=3ex of we-\i}{llb-1-\i}
...
%        \coordinate[left=3ex of llf-1-1] (llf-1-0);
%        \coordinate[left=3ex of llf-2-1] (llf-2-0);
%        \coordinate[right=3ex of llb-1-6] (llb-1-7);
%        \coordinate[right=3ex of llb-2-6] (llb-2-7);
%        \draw
%            (llf-1-0) edge[->] (llf-1-1)
%            (llf-2-0) edge[->] (llf-2-1)
%            (llb-1-7) edge[->] (llb-1-6)
%            (llb-2-7) edge[->] (llb-2-6);
