...
\begin{document}
    ...
    The \deflab{right-branching binarization}[right-branching strategy] \defabrv{right-branching binarization}{\abrv{rb}} constructs nodes as follows:
    \begin{itemize}
    ...
    The parsing complexity with \abrv{lcfrs} instances depends on the fanouts, so binarization strategies may have influence on it.
