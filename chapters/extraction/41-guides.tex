...
%        \mathrm{strict}(\xi)(\rho) = \min \; \yield(\xi|_{\rho\cdot 2})
    ...
    Whereas the previous constructors were defined solely according to the constituent structure, the remaining two take a head assignment into account to incorporate further lunguistic information into the extraction process.
