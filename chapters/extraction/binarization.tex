...
\begin{document}
    ...
    More importantly, these binary grammar instances can be constructed  in similar derivations. This is called \deflab<binariation>{Markovization}.
    ...
    Binarization and head-inward transformation will be referred to as \deflab{rank transformations}.
    ...
    \begin{figure}
        ...
        \caption{\label{fig:extraction:ranks}
            ...
            The right plots show the rank distribution only for nodes with the label \abrv{np}.
