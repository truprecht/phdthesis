...
\begin{document}
    ...
    This \deflab<binarization!binarization strategies>[binarization:r2l]{head-outward binarization}[strategy] mixes left- and right-branching factorization at each higher-ranked node depending on the successor that contains its lexical head.
    ...
    As the parsing complexity with \abrv{lcfrs} instances crucially depends on the fanouts, binarization strategies may have an influence on the parsing effort.
