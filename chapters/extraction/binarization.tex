...
\begin{document}
    ...
    These grammars tend to be rather large and the aforementioned binarization strategies either fail to decrease their size and/or there is no intuitive strategy to assign head positions to the introduced artificial nodes, this issue is described in more detail in \ref{sec:extraction:dep}.
