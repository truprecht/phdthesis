...
\begin{document}
    ...
    \Cref{sec:hyperparameters} describes the options available to steer the supertag extraction and the training process for the classifiers used for supertagging.
