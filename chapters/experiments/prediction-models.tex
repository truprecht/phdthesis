...
\begin{document}
    ...
    \begin{enumerate}
        \item
            ...
            It contains two modules for embedding, a static word embedding and character-wise embeddings, which are followed by two layers of bidirectional recurrent modules utilizing \abrv{lstm}, and finally a three-layered \abrv{mlp} with ReLU activations.
        ...
        \item
            ...
            If we consider the \abrv{llm} as a black box, it is conceptually extremely simple yet effective, but its strength relies upon the complex design and pre-training of the \abrv{llm}.
