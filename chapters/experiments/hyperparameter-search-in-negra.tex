...
\begin{document}
    ...
    \end{compactitem}
    During this grid search, both models are trained for 10 epochs; we chose this rather small amount of training iterations to conduct the experiments in reasonable time.
