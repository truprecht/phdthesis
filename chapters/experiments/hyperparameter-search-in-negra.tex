...
\bottomrule
    ...
    Interestingly, while we could achieve higher scores with \abrv{dcp} supertags using the supervised model, the trend is the opposite with the pre-trained one.
