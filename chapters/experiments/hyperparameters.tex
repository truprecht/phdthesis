...
\begin{document}
    ...
    Moreover, in the case of \abrv{dcp} supertag, we investigate the nof and disc extensions for the nonterminal constructors that remove or change the fanout substript of constructred nonterminals, respectively.
\end{document}