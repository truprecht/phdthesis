...
\begin{document}
    ...
    We developed the software over the course of multiple years. Previous publications already used two iterations for parsing with \abrv{lcfrs} supertags \citep{RupMoe21,Rup22}.
